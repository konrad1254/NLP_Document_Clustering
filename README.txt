...
Important notes / assumptions:
	...
	- Wikipedia extraction: The code extracts 200 summaries per language to fulfil the requirements of the exercise. In the next step, however, the code "forgets" the true labels and uses langdetect to detect the language of the document
